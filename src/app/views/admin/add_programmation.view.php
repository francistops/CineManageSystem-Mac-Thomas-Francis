            ...
            <div class="containterFlexRow">
                <div>
                    ...
                    <form class="bg-shadow-off" method="POST">
                        <label>Titre: <input type="text" name="film_id" required></label><br>
                        <label>Salle: <input type="text" name="salle_id" required></label><br>
                        <label>Admin: <input type="text" name="administrateur_id" required></label><br>
